...
/*global $, jQuery, alert, btoa, AdminLTEOptions, _init, FastClick, start, done, confirm, CKEDITOR*/
...
$(document).ready(function () {
    ...
    $(".form-novo-usuario").submit(function (e) {
	    ...
	    $.post("insertUsuario.php", { nome: $("#nome").val(), usuario: usuario, senha: senha, email: $("#email").val(), tipo: $("input[name='tipo-usuario']:checked").val(), rand: Math.random()}, function (data) {
            $(".btn-submit-novo-usuario").html('<img src="../img/rings.svg" class="loader-svg">').fadeTo(fade, 1);

            switch (data) {
            case 'true':
                $.smkAlert({text: 'Usu&aacute;rio cadastrado com sucesso.', type: 'success', time: 2});
            ...
            $(".btn-submit-novo-usuario").html('Salvar').fadeTo(fade, 1);
        });
    ...
    $(".table-data").on('click', '.delete-usuario', function (e) {
        ...
        $.smkConfirm({
            ...
            if (res) {
                location.href = 'deleteUsuario.php?' + py + '=' + id;
            }
        });
    });
    ...
    $(".form-edita-usuario-single").submit(function (e) {
        e.preventDefault();
        var usuario = btoa($("#usuario").val()), senha = btoa($("#senha").val());

	    $.post("updateUsuario.php", { idlogin: $("#idlogin").val(), nome: $("#nome").val(), usuario: usuario, senha: senha, email: $("#email").val(), rand: Math.random()}, function (data) {
            $(".btn-submit-edita-usuario-single").html('<img src="img/rings.svg" class="loader-svg">').fadeTo(fade, 1);
            ...
            $(".btn-submit-edita-usuario-single").html('Salvar').fadeTo(fade, 1);
        });
