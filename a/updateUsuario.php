    ...
    $msg = "Campo obrigat&oacute;rio vazio.";
        ...
        if($filtro == 5) {
            try {
                ...
                $sql = $pdo->prepare("SELECT idlogin FROM login WHERE email = :email AND idlogin <> :idlogin");
                ...
                $sql = $pdo->prepare("UPDATE login SET nome = :nome,usuario = :usuario,senha = :senha,email = :email,tipo = :tipo WHERE idlogin = :idlogin");
